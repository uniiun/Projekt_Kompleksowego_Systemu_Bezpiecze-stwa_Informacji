        ...
        <div className="col-lg-5 col-md-12">
          <div className="card p-4 h-100">
            ...
            <div className="d-flex flex-column gap-3 mt-2">
              ...
              {role === 'ADMIN' && (
                <a href="http://127.0.0.1:8000/admin/" target="_blank" rel="noopener noreferrer" className="btn btn-outline-light text-start p-3 d-flex align-items-center gap-3 glass-panel-hover" style={{ borderRadius: '12px !important' }}>
                  ...
                  <div>
                    <div className="fw-bold text-white small">Panel Administratora Django</div>
                    <span className="text-white-50" style={{ fontSize: '0.75rem' }}>Pełne zarządzanie bazą danych w Django</span>
                  </div>
                </a>
              )}
            </div>
